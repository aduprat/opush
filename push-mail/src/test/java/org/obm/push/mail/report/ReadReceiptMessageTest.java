...
public class ReadReceiptMessageTest {
	...
	public void fromShouldReturnAbsentWhenDisabledInConfiguration() {
		ReadReceiptMessage testee = new ReadReceiptMessage(new MyTemplateService(), 
	...
	public void fromShouldWork() throws IOException {
		...
		Optional<Message> readReceipt = testee.from(user, MSEmail.builder()
		...
		String expectedMessage = "To: user@opush.org\r\n" + 
			"Subject: Read Receipt (displayed)\r\n" +
			"Content-Type: multipart/report; report-type=delivery-notification;\r\n" +
		...
		new DefaultMessageWriter().writeMessage(readReceipt.get(), outputStream);
